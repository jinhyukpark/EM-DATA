    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      ...
      <AlertDialog open={showConfirmDialog} onOpenChange={setShowConfirmDialog}>
        <AlertDialogContent className="bg-white">
          ...
          <AlertDialogFooter>
            <AlertDialogCancel className="text-slate-700 border-slate-200 hover:bg-slate-100 hover:text-slate-900">Cancel</AlertDialogCancel>
            <AlertDialogAction onClick={confirmAction} className="bg-blue-600 hover:bg-blue-700 text-white">Load Template</AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
    </Dialog>
